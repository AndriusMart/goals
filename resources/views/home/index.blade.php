...
<h1 class="title mid mt-5"><span>My</span>Goals</h1>
            ...
            <div class="card">
                ...
                <div class="card-img mt-3 ">
                    <ul class="list-group">
                        ...
                        @if($goal->done == 1 &&  Auth::user()->id == $goal->user_id)
        ...
        <div class="  carousel-border">
            <div class="card">
                ...
                <div class="card-img mt-3 ">
                    <ul class="list-group">
                        @forelse($goals as $goal)
                        @if($goal->done == 2 &&  Auth::user()->id == $goal->user_id)
